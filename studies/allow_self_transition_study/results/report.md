# Allow Self Transition Study

Boolean structural study of forced element turnover at layer expiry.
...
- Total wall time: 6.3 seconds.

## Aggregate results

| level | episodes/hour | unknown-time fraction | duration p90 (s) | dispersion | C3/C4/C5/C6 |
|---|---:|---:|---:|---:|---:|
| self_transitions_off | 0.03 | 0.0001432 | 30.5028 | 0.9001 | 29.3333/0.6667/0/0 |
| self_transitions_on | 0.02 | 0.0001333 | 47.6747 | 0.5402 | 19.3333/0.6667/0/0 |
...
- `allow_self_transition_study_effects.png`: principal outcomes by level.
